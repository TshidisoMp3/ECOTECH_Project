...
def update_item(item_id):
    if current_user.id == 1:
        ...
        return render_template('update_item.html file here', form=form)
    return render_template('404.html file here')
...
def order_view():
    if current_user.id == 1:
        ...
        return render_template('view_orders.html file here', orders=orders)
    return render_template('404.html file here')
...
def update_order(order_id):
    if current_user.id == 1:
        ...
        return render_template('order_update.html file here', form=form)
...
def display_customers():
    if current_user.id == 1:
        ...
        return render_template('customers.html file here', customers=customers)
    return render_template('404.html file here')
...
def admin_page():
    if current_user.id == 1:
        return render_template('admin.html file here')
    return render_template('404.html file here')
