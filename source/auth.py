...
def sign_up():
    ...
    return render_template('signup.html file here', form=form)
...
def login():
    ...
    return render_template('login.html file here', form=form)
...
def change_password(customer_id):
    ...
    return render_template('change_password.html file here', form=form)
